 ...
 * | =    |   A  |   S  |   D  |   F  |   G  |             |   H  |   J  |   K  |   L  |   ;  |  [   |
 * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
 * | Shift|   Z  |   X  |   C  |   V  |   B  | Alt  | RAISE|   N  |   M  |   ,  |   .  |   /  |Shift |
 * `-------------+------+------+------+------+------+------+------+------+------+------+-------------'
 *               |  `   | Shift|Lower| Ctrl | GUI  |Enter |Space |       |  '   |  \   |
 *               `---------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT( \
  KC_ESC,  KC_1,    KC_2,    KC_3,   KC_4,    KC_5,                       KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINUS, \
  KC_TAB,  KC_Q,    KC_W,    KC_E,   KC_R,    KC_T,                       KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_RBRC, \
  KC_EQUAL,  KC_A,  KC_S,    KC_D,   KC_F,    KC_G,                       KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_LBRC, \
  KC_LSFT, KC_Z,    KC_X,    KC_C,   KC_V,    KC_B,    KC_LALT,  RAISE,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT , \
                KC_GRAVE,  KC_LSFT,  LOWER,   KC_LCTL, KC_LGUI,  KC_ENT,  KC_SPC,  KC_RALT, KC_QUOT, KC_BSLASH\
),
